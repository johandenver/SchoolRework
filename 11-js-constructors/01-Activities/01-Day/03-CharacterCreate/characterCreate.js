...
// create new characters and invoke the properties for the contructor:

var character = new Character("Lazer Face", "teacher", "male", 34, 6, 12);
var character2 = new Character("Bolt Brain", "pilot", "female", 22, 5, 13);
var rogue = new Character("x-raymond", "doctor", "male", 45, 7, 18);
