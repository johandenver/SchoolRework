CREATE TABLE IF NOT EXISTS top5000 (
    `Column_1` INT,
    `Column_2` VARCHAR(60) CHARACTER SET utf8,
    `Column_3` VARCHAR(70) CHARACTER SET utf8,
    `Column_4` INT,
    `Column_5` NUMERIC(5, 3),
    `Column_6` NUMERIC(5, 3),
    `Column_7` NUMERIC(5, 3),
    `Column_8` NUMERIC(5, 3),
    `Column_9` NUMERIC(4, 3)
);
